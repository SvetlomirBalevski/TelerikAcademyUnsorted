...
namespace Academy.Core.Factories
{
    public class AcademyFactory : IAcademyFactory
    {
        ...
        public Models.Student CreateStudent(string username, string track)
        {
            Track parsedTrackAsEnum;
            Enum.TryParse<Track>(track, out parsedTrackAsEnum);

            return new Models.Student(username, parsedTrackAsEnum);
        }
        ...
        Models.Contracts.Student IAcademyFactory.CreateStudent(string username, string track)
        {
