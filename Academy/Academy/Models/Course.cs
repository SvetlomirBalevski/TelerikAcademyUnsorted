...
namespace Academy.Models
{
    public class Course : ICourse
    {
        ...
        public Course(string name, int lecturesPerWeek, DateTime starting, DateTime ending)
        {
            ...
            this.OnlineStudents = new List<Contracts.Student>();
            this.OnsiteStudents = new List<Contracts.Student>();
        ...
        public IList<Contracts.Student> OnsiteStudents { get; private set; }

        public IList<Contracts.Student> OnlineStudents { get; private set; }
